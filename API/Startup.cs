...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<HomelandContext>(opt =>
            {
            ...
            services.AddCors(opt =>
         {
             ...
             {
                 policy.WithOrigins("http://localhost:3000", "http://localhost:4000", "https://betahomeland.aveneur.com", "https://adminhomeland.aveneur.com", "https://www.adminhomeland.aveneur.com").AllowAnyHeader().AllowAnyMethod().AllowCredentials();
             });
         });
